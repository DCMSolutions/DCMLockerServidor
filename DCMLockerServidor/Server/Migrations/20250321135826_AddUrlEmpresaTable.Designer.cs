...
namespace DCMLockerServidor.Server.Migrations
{
    ...
    [Migration("20250321135826_AddUrlEmpresaTable")]
    partial class AddUrlEmpresaTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DCMLockerServidor.Shared.Models.EmpresaUrl", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("url_empresa", (string)null);

                    MySqlEntityTypeBuilderExtensions.UseCollation(b, "utf8mb4_unicode_520_ci");
                });

            modelBuilder.Entity("DCMLockerServidor.Shared.Models.Evento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DCMLockerServidor.Shared.Models.EmpresaUrl", b =>
                {
                    b.HasOne("DCMLockerServidor.Shared.Models.Empresa", "Empresa")
                        .WithMany("Urls")
            ...
            modelBuilder.Entity("DCMLockerServidor.Shared.Models.Evento", b =>
                {
                    b.HasOne("DCMLockerServidor.Shared.Models.Locker", "Locker")
                        .WithMany("Eventos")
                        .HasForeignKey("IdLocker");
