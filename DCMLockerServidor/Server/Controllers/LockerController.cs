    ...
    public class LockerController : ControllerBase
    {
        ...
        public async Task<ServerToken> Post(ServerToken serverCommunication)
        {
            try
            {
                ...
                Console.WriteLine($"token is {token.Modo}");
                Console.WriteLine($"token.Confirmado is {token.Confirmado}");
                Console.WriteLine($"serverCommunication.Box is {serverCommunication.Box}");
